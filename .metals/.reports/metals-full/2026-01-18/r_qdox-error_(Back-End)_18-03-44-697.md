error id: file://<WORKSPACE>/src/main/java/com/safaria/backend/controller/ProfileController.java
file://<WORKSPACE>/src/main/java/com/safaria/backend/controller/ProfileController.java
...
```java
offset: 1200
uri: file://<WORKSPACE>/src/main/java/com/safaria/backend/controller/ProfileController.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/src/main/java/com/safaria/backend/controller/ProfileController.java