...
import com.safaria.backend.Filters.JwtFilter;
import com.safaria.backend.service.CustomUserDetailsService;
        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                http.headers(headers -> headers
                                ...
                                .contentSecurityPolicy(csp -> csp
                                                .policyDirectives("frame-ancestors 'self' http://localhost:4200") // Allow
                                                                                                                  // iframe
                                                                                                                  // from
                                                                                                                  // localhost:4200
                                                                                                                  // (your
